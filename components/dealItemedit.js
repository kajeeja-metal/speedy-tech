    ...
    return (
        ...
        <div className={style.dealItem}>
            ...
            <div className={style.group_dealitem}>
                <div className={style.deal_name}><span className={style.rowfisrt}>{props.dealItem.order?.name[locale] ? props.dealItem.order?.name[locale] : props.dealItem.order?.name["th"]}</span><span className={style.prices}>฿ {(props.dealItem.order.sale_price != 0 ? props.dealItem.order.sale_price.toLocaleString('en-US') :  (props.dealItem.order.price) + props.dealItem.sumTotal).toLocaleString('en-US')} x {count}</span></div>
